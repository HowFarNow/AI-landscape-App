      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <img src="./assets/Pragmatex Logo White - strap.svg" alt="Pragmatex" style={{ height: 48, width: "auto" }} />
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
                <div style={{ display: "flex", gap: 12 }}>
                  <span style={{ fontSize: 11, color: "#94a3b8" }}>● Org Use Case</span>
                  <span style={{ fontSize: 11, color: "#c084fc" }}>● Big Opportunity</span>
                </div>
                <div style={{
                  ...
                  {!submitted && (
                    <button onClick={submitVotes} disabled={selected.length === 0} style={{
                      ...
                      fontSize: 12, fontWeight: 700, cursor: selected.length > 0 ? "pointer" : "default",
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
              {[["all", "#64748b", "All"], ["efficiency", "#4ade80", "Create Efficiency"], ["improve", "#fcd34d", "Improve Existing"], ["new", "#67e8f9", "Enabling New"]].map(([key, color, label]) => (
                <button key={key} onClick={() => setFilterDim(key)} style={{
                  padding: "5px 12px", borderRadius: 20, fontSize: 11, letterSpacing: "0.05em",
            ...
            {["operational", "business"].map(fn => (
              <div key={fn} style={{ marginBottom: 12 }}>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: 11, letterSpacing: "0.15em", color: fn === "operational" ? "#60a5fa" : "#a78bfa", textTransform: "uppercase", fontWeight: 700 }}>
                  ...
                  {["efficiency", "improve", "new"].map(dim => {
                    ...
                    return (
                      <div key={dim} style={{
                        ...
                        <div style={{ fontSize: 10, letterSpacing: "0.12em", color: dc.text, textTransform: "uppercase", fontWeight: 700, marginBottom: 8, opacity: 0.9 }}>
                          {dc.label}
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                          {items.map(uc => {
                            ...
                            return (
                              ...
                              >
                                <span style={{ fontSize: 7, color: CAT_COLORS[uc.category].dot, marginTop: 3, flexShrink: 0 }}>●</span>
                                <span style={{ fontSize: 11, color: isSelected ? "#f1f5f9" : "#94a3b8", lineHeight: 1.4, flex: 1 }}>
                                  {uc.label}
                                </span>
                                {isSelected && <span style={{ fontSize: 10, color: dc.text, flexShrink: 0 }}>✓</span>}
                                {voteCount > 0 && !isSelected && (
                                  <span style={{ fontSize: 9, color: "#475569", flexShrink: 0 }}>{voteCount}v</span>
                                )}
                              </div>
                            );
                          })}
                      ...
                      return (
                        <div key={uc.id} style={{ position: "relative" }}>
                          ...
                          <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 8, padding: "5px 8px" }}>
                            ...
                            <span style={{ fontSize: 7, color: CAT_COLORS[uc.category].dot, flexShrink: 0 }}>●</span>
